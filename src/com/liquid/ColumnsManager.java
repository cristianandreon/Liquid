        ...
        try {
            ...
            if(tbl_wrk != null && tbl_wrk.tableJson!=null) {
                ...
                if("getColumnsManager".equalsIgnoreCase(operation)) {
                    ...
                    +",\"primaryKey\":\"NAME\""
                    +",\"columns\":["
                    +" { \"name\":\"FIELD\", \"label\":\"Field\", \"field\":\""+String.valueOf(cField++)+"\", \"width\":\"50\", \"readonly\":true, \"pinned\":\"left\", \"lockPinned\":true }"
                    ...
                    +",{ \"name\":\"TYPE\", \"label\":\"Type\", \"field\":\""+String.valueOf(cField++)+"\", \"width\":\"50\", \"readonly\":true }"
                    +",{ \"name\":\"LABEL\", \"label\":\"Label\", \"field\":\""+String.valueOf(cField++)+"\", \"width\":\"100\" }"
                    +",{ \"name\":\"WIDTH\", \"label\":\"Width\", \"field\":\""+String.valueOf(cField++)+"\", \"width\":\"50\" }"
                    +",{ \"name\":\"VISIBLE\", \"label\":\"Visible\", \"field\":\""+String.valueOf(cField++)+"\", \"width\":\"50\", \"editor\":{ \"type\":\"values\", \"values\":[\"true\",\"false\"] } }"
                    +",{ \"name\":\"READONLY\", \"label\":\"Readonly\", \"field\":\""+String.valueOf(cField++)+"\", \"width\":\"50\", \"editor\":\"values\", \"editorValues\":[\"true\",\"false\"] }"
                    +",{ \"name\":\"LINK\", \"label\":\"Visible\", \"field\":\""+String.valueOf(cField++)+"\", \"width\":\"50\", \"editor\":{ \"type\":\"values\", \"values\":[\"true\",\"false\"] } }"
                    ...
                    +",{ \"name\":\"AUTO_COMPLETE\", \"label\":\"Autocomplete\", \"field\":\""+String.valueOf(cField++)+"\", \"width\":\"50\", \"editor\":\"values\", \"editorValues\":[\"true\",\"false\"] }"
